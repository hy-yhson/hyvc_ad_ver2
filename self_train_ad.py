...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='../data/mvtec_10_jiin')
    parser.add_argument('--save_path', type=str, default='../data/glml')
    parser.add_argument('--feature_path', type=str, default='../data/dino_feature')
    parser.add_argument('--synthetic_path', type=str, default='../data/sdas_perlin_0')
